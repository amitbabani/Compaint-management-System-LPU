...
<footer class="page-footer font-small text-light" style="background: linear-gradient(to left bottom, #8e2de2, #111 60%); box-shadow: 0px 0px 10px 4px #000;">
  ...
  <div style="background: linear-gradient(to left, #8e2de2 , #111 70%); box-shadow: 0px 0px 4px 1px #000;">
    <div class="container">
      ...
      <div class="col-md-6 col-lg-7 text-center text-md-right py-2 social">
        <!-- Facebook -->
        <a class="icons px-2" href="https://www.facebook.com/LPUUniversity">
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-1">
      ...
      <div class="col-md-4 col-lg-4 col-xl-4 mx-auto mb-1">
        ...
        <p>
          <i class="fa fa-envelope mr-2"></i> Lpu@gmail.com
        </p>
        <p>
          <i class="fa fa-phone mr-2"></i> + 91 907 987 3040
        </p>
      </div>
      <!-- Grid column -->
  ...
  <div class="footer-copyright text-center py-3" id="footer-copyright">&copy; <script>document.getElementById('footer-copyright').innerHTML += new Date().getFullYear();</script> Copyright by LPU | 
